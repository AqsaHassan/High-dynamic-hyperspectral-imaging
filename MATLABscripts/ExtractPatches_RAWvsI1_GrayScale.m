...
pathI1 = '/Users/gtrumpy/Desktop/CVCL/research/HScamera/CCpassportTEST/';
fileI1 = 'I1spectra.txt';

xrite = importdata([pathI1 fileI1]);
...
plot(bands,spectraRAW(:,19),'k','LineWidth',2)
hold on
plot(xrite(:,1),xrite(:,20),'ko')

for i=20:24
    
    plot(bands,spectraRAW(:,i),'k','LineWidth',2)
    plot(xrite(:,1),xrite(:,i+1),'ko')
