function [imgOut, pAlpha, pWhite] = ReinhardTMO_hyperspectral(img, pAlpha, pWhite, pLocal, pPhi, Lwa)
%
%
...
%change luminance
imgOut = ChangeLuminance_hyperspectral(img, L, Ld);
